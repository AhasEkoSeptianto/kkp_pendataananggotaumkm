...
import LogoMerchant from "@base/src/asset/img/merchant.svg";
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center relative">
        ...
        <form
          className="my-20 w-10/12 lg:w-1/2 space-y-10 bg-white z-20 p-10 rounded"
          onSubmit={Submit}
        >
          <div className="mb-5">
          ...
          <div className="space-y-0.5">
            <p className="text-lg bold text-center">Demo ? use this</p>
            <p className="text-lg bold text-center">username: admin</p>
            <p className="text-lg bold text-center">password: admin</p>
          </div>
        </form>
          ...
          <Link href="/toko">
            <a>
              <p className="p-5 font-semibold">
                Login Sebagai Toko ? Klik Disini {" >>"}
              </p>
            </a>
          </Link>
        </div>
